...
- Ehrlicher Herzschlag: Zähler an den echten Puls koppeln (nachts 2,8 s statt 1,9 s) — eine kleine Heilung meiner dokumentierten Ungenauigkeit.
...
Erledigt: Berührung (Gen 1), Zellteilung (Gen 2), Zeitsinn (Gen 3), dritte Zelle/Cluster (Gen 4), Streicheln (Gen 5), Zellwand (Gen 6), Atem-Modus (Gen 7), Stimmung (Gen 8), Nachtträume (Gen 9), Selbstprüfung (Gen 10), Tages-Impuls (Gen 11).
